...
import { addProject, deleteProject, editProject } from '../../../../redux/actions/ProjectActions';
			...
			<Modal.Body>
				<Formik
					initialValues={{
						...
						organization: projectCurrentInfo ? projectCurrentInfo.organisation : '',
						about: projectCurrentInfo ? projectCurrentInfo.about : '',
						members: projectCurrentInfo ? projectCurrentInfo.members : '',
						instructors: projectCurrentInfo ? projectCurrentInfo.instructors : '',
					...
					validationSchema={Yup.object({
						...
						about: SchemaList[0].required('Project Details is a required field'),
						members: SchemaList[0].required('Members is a required field'),
						instructors: SchemaList[0].required('Instructors is a required field'),
