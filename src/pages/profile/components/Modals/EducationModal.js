...
const EducationModal = ({
	...
	console.log("educationCurrentInfo:::", educationCurrentInfo);
	...
	return (
		...
		>
			...
			<Modal.Body>
				<Formik
					initialValues={{
						school: educationCurrentInfo ? educationCurrentInfo.school : "",
						degree: educationCurrentInfo
							? educationCurrentInfo.degree?._id
							: "",
						fieldOfStudy: educationCurrentInfo
							? educationCurrentInfo?.fieldOfStudy?._id
							: "",
						grade: educationCurrentInfo ? educationCurrentInfo.grade : "",
						startMonth: educationCurrentInfo
							? educationCurrentInfo.startMonth
							: "",
						startYear: educationCurrentInfo
							? educationCurrentInfo.startYear
							: "",
						endMonth: educationCurrentInfo ? educationCurrentInfo.endMonth : "",
						endYear: educationCurrentInfo ? educationCurrentInfo.endYear : "",
						description: educationCurrentInfo
							? educationCurrentInfo.description
							: "",
					}}
					validationSchema={Yup.object({
						school: SchemaList[0].required("school is a required field"),
						degree: SchemaList[0].required("degree is a required field"),
						fieldOfStudy: SchemaList[0].required(
							"fieldOfStudy is a required field"
						),
									...
									<div className="row">
										<div className="col-sm-6 col-padding-left">
											{educationCurrentInfo ? (
												<button
													onClick={async () => {
														console.log("ID:::", educationCurrentInfo?._id);
