      ...
      <Modal.Body>
        <Formik
          initialValues={{
            ...
            degree: educationCurrentInfo ? educationCurrentInfo.degree?._id : '',
            fieldOfStudy: educationCurrentInfo ? educationCurrentInfo?.fieldOfStudy?._id : '',
            grade: educationCurrentInfo ? educationCurrentInfo.grade : '',
            startMonth: educationCurrentInfo ? educationCurrentInfo.startMonth : '',
