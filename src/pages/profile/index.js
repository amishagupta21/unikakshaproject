    ...
    <div className="profile-page">
      ...
      <div className='profile-information-status-right'>
        <div className='row'>
          ...
          <a href="" className='btn btn-info'>Download</a>

          </div> </div>
          <div className='col-sm-5'>
          <div className='profile-company'>
           
           <p className='mb-0 job-title '>ABC pvt limited </p>
           <p className=' job-type '>Internship</p>
         
         <p className='city '>Vadodara, <strong>Gujarat</strong></p>
       </div>
          </div>
        </div>
    ...
    <div className='current-status'>
     ...
     <div className='profile-box-column'>
       <div className='row'>
         ...
         <div className='box-color'   style={{background: "#C8DEFF"}}>
           
           </div>
         </div>
         <div className='col-sm-4'>
         <div className='box-color' style={{background: "#DEF3C1"}}>
           
           </div>
         </div>
         <div className='col-sm-4'>
         <div className='box-color' style={{background: "#FBD0C1"}}>
