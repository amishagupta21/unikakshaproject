...
const Profile = () => {
  ...
  const [projectCurrentInfo, setProjectCurrentInfo] = useState('');
        ...
        <div className="row-profile-left">
          ...
          <div className="profile-box">
            <div className="profile-background">
              <img
                className="edit-icon"
                onClick={() => setIsShowIntroductionModal(true)}
                src={editIcon}
              />
            </div>
                ...
                <div className="row">
                  <div className="col-sm-7">
                    <div className="profile-pdf-download">
                      ...
                      <a className="btn btn-info">Download</a>
                    </div>
                  </div>
