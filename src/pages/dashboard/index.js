									...
									<Table>
										...
										<tbody>
											<tr>
												...
												<td>24h 13m 28s</td>
												<td>
													<div className='sucess-status'>
														<i></i> <span>Sashank</span>
													</div>
												</td>
											</tr>
											<tr>
										...
										<div className='row'>
											<div className='col-sm-4'>
												<div className='recomended-box'>
													<div className='box-grid green'></div>
													<div className='grid-content'>
														...
														<a
															href=''
															className='btn btn-info btn-primary  border-radius'
														>
															<svg
											...
											<div className='col-sm-4'>
												<div className='recomended-box'>
													<div className='box-grid blue'></div>
													<div className='grid-content'>
														<h4>Search Engin</h4>
														...
														<a
															href=''
															className='btn btn-info btn-primary border-radius btn-disable-color'
														>
															<svg
																xmlns='http://www.w3.org/2000/svg'
																width='20'
											...
											<div className='col-sm-4'>
												<div className='recomended-box'>
													<div className='box-grid yellow'></div>
													<div className='grid-content'>
														<h4>UI Design</h4>
