...
import { Carousel, FormCheck, FormControl, FormGroup, FormLabel } from 'react-bootstrap';
                ...
                <Form>
                  ...
                  <Field
                    ...
                    render={({ field, formProps }) => (
                      <Row className="mb-0">
                        <FormGroup controlId="email" className="form-group-1 mb-3" as={Col} md="12">
                  ...
                  <div>
                    <Field
                      ...
                      render={({ field, formProps }) => (
                        <FormGroup className="custom_checkbox" controlId="termsAndConditions">
                          <FormCheck
                            type={'checkbox'}
                            value={field.value}
                            onChange={field.onChange}
