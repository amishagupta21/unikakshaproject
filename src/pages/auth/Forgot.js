...
const Forgot = () => {
  return (
    ...
    <div className='back-action'>
      ...
      <Form noValidate>
        <h2 className='title-head'>Forgot password</h2>
      <Row className="mb-0"> 
        <Form.Group className="form-group-1 mb-4" as={Col} md="12" controlId="validationCustom03">
          <Form.Label className='custom-label'>Forgot password</Form.Label>
...
" required />
        ...
        <Button type="submit" variant="info" className='btn-lg  justify-content-center mt-3'> <Link to="/setpassword">Forgot password</Link></Button>
        </div>
