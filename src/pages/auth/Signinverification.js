        ...
        <div className="right_box_container">
          ...
          <div className="auth_form auth_form-verification">
            ...
            <p className="text-center mt-2">
              We've just emailed a verification link to <a href="">rajpatel@gmail.com</a>. Once it
              arrives,
              <br />
            ...
            <div className="button d-flex clearfix">
              <Button variant="info" className="btn-lg  justify-content-center btn-border mt-2">
                Back to sign-in{' '}
              </Button>
            </div>
