...
const CourseApplication = () => {
  ...
  const fetchUserDetails = async () => {
    ...
    if (education_details?.qualification.length) {
      nextPageNumber(2)
    }
  };

  const setPersonalDetailsInForm = () => {
    formik.setValues(personalDetails);
    setGenderValue(personalDetails.gender);
  }
      ...
      <div className="px-5 my-5 mx-5 course-application">
        ...
        <Card className="view-course border">
          <Card.Body
            ...
            <div>
              <Card.Link style={{ fontSize: '18px', fontWeight: '500', color: '#EF6B29' }} href="#">
                View Course
              </Card.Link>
            </div>
          </Card.Body>
                  ...
                  <Row className="mb-5">
                    <Form.Group as={Col} controlId="full_name">
                      ...
                      <Form.Control
                        ...
                        className={
                          formik.touched.full_name && formik.errors.full_name ? 'is-invalid' : null
                        }
